 ...
 *   - A RELATIVE path ("/sparql") stays same-origin — no CORS involved. Best for a static site whose
 *     reverse proxy exposes the endpoint under the same host (e.g. /sparql -> internal triplestore).
