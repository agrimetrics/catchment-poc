# demonstrator-poc [OUTDATED/NOT FUNCTIONAL]

Please ignore this folder, it is the remnants of my first attempt at the demonstrator where I tried to link sampling point to permit via first finding the closest matching discharge point.
